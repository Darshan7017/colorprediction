...
$error ='<div class="alert alert-danger alert-dismissible" role="alert">
                    ...
                    Please Activate Your Telegram Bot Alert By <a href="https://telegram.dog/Fastbackalertbot?start='.$phone.'" target="_blank"
style="text-decoration: none; color: #fff;"> Clicking Here </a>
                  </div>';
...
if(isset($_GET['tk'])){
	...
	$insert="UPDATE `user` SET `botalert`='$id' WHERE `mail`='$user'";
	...
	if($ins){
		$error = '<div class="alert alert-success alert-dismissible" role="alert">
                    ...
                    Bot Alert Activated Successfully 
                  </div>';
		} else {
                ...
                <div class="card-body">
                  <div class="row align-items-center">
                    <div class="col mr-2">
                      ...
                      <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo $data['user']; ?></div>
                ...
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      ...
                      <div class="h5 mb-0 font-weight-bold text-gray-800">₹<?php echo $data['bal']; ?></div>
                ...
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      ...
                      <div class="h5 mb-0 font-weight-bold text-gray-800">₹<?php echo $data['tfund']; ?></div>
                ...
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      ...
                      <div class="h5 mb-0 font-weight-bold text-gray-800">₹<?php echo $data['wfund']; ?></div>
